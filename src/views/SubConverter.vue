<template>
  <div>
    <h2 style="text-align: center; margin-top: 20px;">订阅转换</h2>
                ...
                <el-collapse>
                  <el-collapse-item>
                    ...
                    <el-form-item class="eldiy" label-width="0px">
                      <el-row type="flex">
                        <el-col>
                          <el-checkbox v-model="form.nodeList" label="仅输出节点信息" border>
                          </el-checkbox>
                        </el-col>
...
export default {
  data() {
    return {
      ...
      form: {
        sourceSubUrl: '',
        clientType: 'clash',
        customBackend: this.getUrlParam() == '' ? 'https://s.lqq.ai' : this.getUrlParam(),
  ...
  methods: {
    ...
    renderPost() {
      ...
      data.append(
          'newname',
          encodeURIComponent(this.form.new_name.toString())
      );
      return data;
    },
    confirmUploadScript() {
